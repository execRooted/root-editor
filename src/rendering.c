...
void render_screen(EditorState * state) {
        ...
        mvprintw(max_y - 1, 0, "Line: %d, Col: %d | %s | Syntax HL: %s | Brackets and Quotes Autocomplete: %s | autocomplete: %s | Auto Tabbing: %s | Autosave: %s",
...
void init_theme_colors(EditorState* state) {
    ...
    if (t == 0) {
        ...
        init_pair(28, COLOR_WHITE,  COLOR_WHITE);
